...
from app.constants import METADATA_TYPE_WALLET_PROVIDER
...
class ProviderService(BaseService):
    ...
    def wallet_provider_list(self, url):
        ...
        wallet_provider_list = self.call_endpoint(
            url,
    ...
    def __check_wallet_provider(self, wallet_provider_list: list[str], wallet_provider):
        logger.info(
            f"Entering method: check_wallet_provider. Params [wallet_provider_list: {wallet_provider_list}, wallet_provider: {wallet_provider}]"
        )
